...
Vuelves tras ~1 año de destreno. **El objetivo NO es recuperar marcas, es volver a
...
Correctivo entre series (en el hueco de la sentadilla, 180s): face pull o dead bug.
...
Correctivo entre series (en el hueco de la banca, 180s): rueda abdominal (ROM parcial→completo).
...
Correctivo entre series (en el hueco del peso muerto, 210s): core suave / respiración.
